...
export function Header({ className }: SidebarProps) {
            ...
            <Link
              ...
              className={cn(
                `py-1 pointer block w-fit bg-left-bottom bg-gradient-to-r
                  ...
                  bg-no-repeat hover:bg-[length:100%_3px] hover:from-[#88B04B]
                  hover:to-[#88B04B] transition-all duration-500 ease-out`,
  ...
  return (
    <div
      ...
      className={cn(
        `flex py-2 items-center justify-center w-full border-b
          shadow-[0_6px_20px_-15px_rgba(0,0,0,0.2)]`,
        className
      )}
    >
